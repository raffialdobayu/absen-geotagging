                    ...
                    <tr>
                      ...
                      <td class="align-middle text-sm">
                        <div class="col text-center">
                          ...
                          <form action="{{ route('siswa.destroy', $k->NIS) }}" method="POST">
                            @csrf
                            @method("DELETE")
                            <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#updateSiswaModal" data-remote="{{ route("siswa.edit", $k->NIS) }}" data-title=""><i class="fa-solid fa-pencil"></i></button>
                            <button  class="btn btn-danger" data-bs-toggle="modal" ><i class="fa-solid fa-trash"></i></button>
                          </form>
