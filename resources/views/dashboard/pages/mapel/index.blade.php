...
<main class="main-content position-relative border-radius-lg ">
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Data Store Mapel</h6>
                <button type="button" class="btn bg-gradient-success" data-bs-toggle="modal" data-bs-target="#applySiswaModal" data-remote="{{ route("mapel.create") }}"><i class="fa-solid fa-circle-plus"></i> Tambah Mata Pelajaran</button>
              </div>
            </div>
              ...
              <table class="table align-items-center" id="table-jabatan">
                <thead>
                  <tr>
                    ...
                    <td>
                        <div class="text-center">
                          <p class="text-xs font-weight-bold mb-0">Pengajar</p>
                        </div>
                    </td>
                    <td>
                        <div class="text-center">
                    ...
                    <td>
                        <div class="text-center">
                          <p class="text-xs font-weight-bold mb-0">Waktu Mulai</p>
                        </div>
                    </td>
                    <td>
                        <div class="text-center">
                          <p class="text-xs font-weight-bold mb-0">Waktu Selesai</p>
                        </div>
                    </td>
                    <td>
                        <div class="text-center">
                ...
                <tbody>
                  @forelse ($data as $d)
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $d->kode }}</h6>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $d->pengajar }}</h6>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $d->nama }}</h6>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $d->getKelas->kelas }}</h6>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $d->mulai }}</h6>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $d->selesai }}</h6>
                        </div>
                      </td>
                      <td class="align-middle text-sm">
                        <a class="btn btn-primary" href=""><i class="fa-solid fa-user-check"></i></a>
  ...
  @include('dashboard.pages.mapel.modals')
