      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-12 mb-lg-0 mb-4 p-3">
          <div class="card p-4">
            ...
            {{-- {{ dd(request()) }} --}}
            <form role="form text-left" enctype="multipart/form-data" method="POST" action="{{ route("presensi.store") }}">
                @method("POST")
                @csrf
                <label>Siswa</label>
                  <div class="input-group mb-3">
                    <input name="NIS" type="text" class="form-control" placeholder="NIS"  value="{{ request()->route()->presensi }}" readonly>
                  </div>
                  <label>Mata Pelajaran</label>
                  <select class="form-control" id="exampleFormControlSelect1" name="kode_mapel" required>
                    <option disabled>-- Pilih Kelas --</option>
                    @foreach (getMapelByKelas(request()->route()->presensi) as $item)
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                ...
                <a type="button" class="btn bg-gradient-success"  href="{{ route("presensi.pdf",request()->route()->presensi ) }}"><i class="fa-solid fa-circle-plus"></i> Download Rekap Presensi Harian</a>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-sm">
                        <div class="col text-center">
                          ...
                          <a type="button" class="btn btn-info" href="http://maps.google.co.id/?q={{  $k["lat"]}},{{  $k["long"] }}"><i class="fa-solid fa-earth-asia"></i></a>
                          <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#detailPresensiModal" data-remote="{{ route("presensi.detail", $k->id) }}" data-title=""><i class="fa-solid fa-circle-info"></i></button>
