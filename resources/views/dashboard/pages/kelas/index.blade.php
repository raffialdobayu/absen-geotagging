...
<main class="main-content position-relative border-radius-lg ">
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Data Store Kelas</h6>
                <button type="button" class="btn bg-gradient-success" data-bs-toggle="modal" data-bs-target="#applySiswaModal" data-remote="{{ route("kelas.create") }}"><i class="fa-solid fa-circle-plus"></i> Tambah Kelas</button>
              </div>
            </div>
              ...
              <table class="table align-items-center" id="table-jabatan">
                <thead>
                  <tr>
                    ...
                    <td>
                        <div class="text-center">
                          <p class="text-xs font-weight-bold mb-0">Wali Kelas</p>
                        </div>
                    </td>
                    <td>
                        <div class="text-center">
                ...
                <tbody>
                  @forelse ($data as $d)
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $d->kelas }}</h6>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <h6 class="text-sm mb-0">{{ $d->wali_kelas }}</h6>
                        </div>
                      </td>
  ...
  @include('dashboard.pages.kelas.modals')
