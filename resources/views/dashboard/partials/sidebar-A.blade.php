<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main" data-color="warning">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        <img src="{{ asset("/argon_assets/img/smk6.png") }}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">SMKN 6 Bekasi</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="Absensimenu">
            <ul class="nav ms-4">
              <li class="nav-item ">
                <a class="nav-link " href="{{ route("presensi.siswa.index") }}">
                  <span class="sidenav-mini-icon"> AG </span>
                  <span class="sidenav-normal"> Siswa</span>
                </a>
              </li>
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-plain shadow-none" id="sidenavCard">
        <img class="w-50 mx-auto" src="{{ asset("/argon_assets/img/smk6.png") }}" alt="sidebar_illustration">
