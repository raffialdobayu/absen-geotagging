...
<script src="{{ asset('/argon_assets/js/plugins/chartjs.min.js') }}"></script>
...
<script src="{{ asset('/bootstrap-datepicker/js/moment.min.js') }}"></script>
<script src="{{ asset('/bootstrap-datepicker/js/bootstrap-datetimepicker.min.js') }}"></script>

@include('dashboard.includes.datatables')